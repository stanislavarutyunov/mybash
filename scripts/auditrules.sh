...
sed "s|<UID_MIN>|${uid_min}|g" /etc/audit/rules.d/00-siem.rules >> /etc/audit/rules.d/00-siem.rules.tmp && mv /etc/audit/rules.d/00-siem.rules.tmp /etc/audit/rules.d/00-siem.rules
